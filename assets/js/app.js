 ...
 * @link https://botosani.digital
 * @link https://oras.digital
 *
 * @copyright (c) Botosani Digital [https://botosani.digital]
 */
...
const app = (() => {
    ...
    const map = {
        // Map configuration
        ref: null,
        mapCenter: {lat: 47.745144, lng: 26.662535},
        loaded: false,
        popup: null,
     ...
     * @type {string}
     */
    const cdn = 'https://botosani.digital/assets/';
    ...
    function render() {
        ...
        events.add('mapRenderControls', () => {
            ...
            if (mapControls && map.loaded) {
                ...
                centerMapControl.title = `Centrează harta pe Municipiul Botoșani`;
